...
class MainActivity : AppCompatActivity() {
    ...
    private fun setViewElements() {
        ...
        val lemonImageChange : ImageView = findViewById(R.id.image_lemon_state)
        ...
        lemonImageChange.setImageResource(drawableResource)
